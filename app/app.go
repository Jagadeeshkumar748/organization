...
import (
	...
	orgmodule "org/x/org"
	orgmodulekeeper "org/x/org/keeper"
	orgmoduletypes "org/x/org/types"
...
type App struct {
	*baseapp.BaseApp
	...
	OrgKeeper orgmodulekeeper.Keeper
...
func New(
	...
	app.OrgKeeper = *orgmodulekeeper.NewKeeper(
		appCodec,
		keys[orgmoduletypes.StoreKey],
		keys[orgmoduletypes.MemStoreKey],
		app.GetSubspace(orgmoduletypes.ModuleName),
	)
	orgModule := orgmodule.NewAppModule(appCodec, app.OrgKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(orgmoduletypes.ModuleName)
